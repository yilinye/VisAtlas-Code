<!--
 * @Author: Qing Shi
 * @LastEditTime: 2022-04-09 10:28:30
 * @Knowledge: 
 * @Description: 
 * @Attention: 
-->
  ...
  methods: {
    ...
    drawRectAndAxis: function (hisArray, hisType) {
      ...
      const yAxis = d3.scaleLinear()
        ...
        .range([hisHeight - 120, 0]);
      console.log(1);
      his_g.append('g')
        .call(d3.axisBottom(xAxis).ticks(5))
        .attr("transform", `translate(${0.2 * hisWidth}, ${hisHeight - 20})`);

      his_g.append('g')
        .call(d3.axisLeft(yAxis).ticks(5))
        .attr("transform", `translate(${0.2 * hisWidth}, ${hisHeight - 120})`);
